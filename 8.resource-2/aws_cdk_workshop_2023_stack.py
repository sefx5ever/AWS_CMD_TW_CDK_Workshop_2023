...
class AwsCdkWorkshop2023Stack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        cloudfront.Distribution(self,  f"aws-cmd-cloudfront-{USER_NAME}",
            default_behavior=cloudfront.BehaviorOptions(origin=website_bucket.bucket_website_domain_name)
        )